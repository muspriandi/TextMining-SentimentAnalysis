...
from application.controllers.kamuspositif import KamusPositifController
from application.controllers.kamusnegatif import KamusNegatifController
...
def positive_word():
	...
	if request.method == 'POST':
		controller_kamuspositif.add_dataPositiveWord()	# Memanggil fungsi 'add_dataPositiveWord()' menggunakan Instance 'controller_kamuspositif'
...
def list_positive_word():
	data_positive_word = controller_kamuspositif.select_dataPositiveWord()	# Memanggil fungsi 'select_dataPositiveWord()' menggunakan Instance 'controller_kamuspositif'
	return { 'data': data_positive_word }

# Ubah Data kata Positive
@app.route('/positive-word/ubah', methods=['POST'])
def ubah_positive_word():
	controller_kamuspositif.update_dataPositiveWord()	# Memanggil fungsi 'update_dataPositiveWord()' menggunakan Instance 'controller_kamuspositif'
...
def hapus_positive_word():
	controller_kamuspositif.delete_dataPositiveWord()	# Memanggil fungsi 'delete_dataPositiveWord()' menggunakan Instance 'controller_kamuspositif'
	return redirect(url_for('positive_word'))
...
def negative_word():
	...
	if request.method == 'POST':
		controller_kamusnegatif.add_dataNegativeWord()	# Memanggil fungsi 'add_dataNegativeWord()' menggunakan Instance 'controller_kamusnegatif'
...
def list_negative_word():
	data_negative_word = controller_kamusnegatif.select_dataNegativeWord()	# Memanggil fungsi 'select_dataNegativeWord()' menggunakan Instance 'controller_kamusnegatif'
	return { 'data': data_negative_word }

# Ubah Data kata Negative
@app.route('/negative-word/ubah', methods=['POST'])
def ubah_negative_word():
	controller_kamusnegatif.update_dataNegativeWord()	# Memanggil fungsi 'update_dataNegativeWord()' menggunakan Instance 'controller_kamusnegatif'
...
controller_visualisasi = VisualizationController()	# Menetapkan Instance dari Class VisualizationController ================

# Visualisasi Data
@app.route('/visualization', methods=['GET'])
def visualization():
	data = controller_visualisasi.get_visualisasiHasil()	# Memanggil fungsi 'get_visualisasiHasil()' menggunakan Instance 'controller_visualisasi'
