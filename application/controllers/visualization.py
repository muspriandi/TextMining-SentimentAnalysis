...
class VisualizationController:
	...
	def get_visualisasiHasil(self):
		...
		waktu_sekarang = datetime.today().strftime('%d-%m-%Y %H%M')
		...
		try:
			...
			wordcloud.to_file('application/static/wordcloud/wordcloud_visualisasiPositive('+ waktu_sekarang +').png')
		...
		# mencari frekuensi dari kata sentimen negatif
		counts = {}
